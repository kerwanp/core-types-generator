--- @class AIActivity AIActivity is an Object registered with an `AIActivityHandler`, representing one possible activity that the handler may execute each time it ticks.
...
--- @class GlobalAIActivity AIActivity is an Object registered with an `AIActivityHandler`, representing one possible activity that the handler may execute each time it ticks.
AIActivity = {}
...
--- @field owner Object Assigning an owner applies the Ability to that Player.
--- @field type string 
...
--- @class AbilityPhaseSettings Each phase of an Ability can be configured differently, allowing complex and different Abilities. AbilityPhaseSettings is an Object.
...
--- @class GlobalAbilityPhaseSettings Each phase of an Ability can be configured differently, allowing complex and different Abilities. AbilityPhaseSettings is an Object.
...
--- @field hitObject Object Object under the reticle, or center of the screen if no reticle is displayed. Can be a Player, StaticMesh, etc.
...
--- @class CoreObject CoreObject is an Object placed in the scene hierarchy during edit mode or is part of a template. Usually they'll be a more specific type of CoreObject, but all CoreObjects have these properties and functions:
...
--- @class GlobalCoreObject CoreObject is an Object placed in the scene hierarchy during edit mode or is part of a template. Usually they'll be a more specific type of CoreObject, but all CoreObjects have these properties and functions:
CoreObject = {}
...
--- @field other Object Reference to a CoreObject or Player impacted.
...
--- @field targetObject Object Reference to the CoreObject/Player hit by the Weapon.
...
--- @class Player Player is an object representation of the state of a player connected to the game, as well as their avatar in the world. Player also implements the [Damageable](damageable.md) interface.
...
--- @field respawnedEvent Event Fired when the Player respawns. *This event has been deprecated. Please use spawnedEvent instead.*
...
--- @class GlobalPlayer Player is an object representation of the state of a player connected to the game, as well as their avatar in the world. Player also implements the [Damageable](damageable.md) interface.
Player = {}
...
--- @class Projectile Projectile is a specialized Object which moves through the air in a parabolic shape and impacts other objects. To spawn a Projectile, use `Projectile.Spawn()`.
...
--- @field homingTarget Object The projectile accelerates towards its target. Homing targets are meant to be used with spawned projectiles and will not work with weapons.
...
--- @class GlobalProjectile Projectile is a specialized Object which moves through the air in a parabolic shape and impacts other objects. To spawn a Projectile, use `Projectile.Spawn()`.
Projectile = {}
...
--- @class ScriptAsset ScriptAsset is an Object representing a script asset in Project Content. When a script is executed from a call to `require()`, it can access the script asset using the `script` variable.. . This can be used to read custom properties from the script asset.
...
--- @class GlobalScriptAsset ScriptAsset is an Object representing a script asset in Project Content. When a script is executed from a call to `require()`, it can access the script asset using the `script` variable.. . This can be used to read custom properties from the script asset.
ScriptAsset = {}
